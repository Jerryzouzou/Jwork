...
public class TitanicTextView extends TextView {
    ...
    public TitanicTextView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public TitanicTextView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
